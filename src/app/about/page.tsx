    ...
    <div className="space-y-10">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-3 space-y-3 text-base text-slate-700">
          <p>製造業での現場経験を通じて、手作業によるミスや属人化しやすい業務の課題を肌で感受到めてきました。</p>
          <p>その経験から「整理して、仕組み化して、運用まで考える」というアプローチでDX推進に取り組んでいます。</p>
          <p>独学でNext.js・TypeScript・Supabase・GASを習得し、AIツールを活用した開発（バイブコーディング）を実践。</p>
          <p>複数のAIサービスを組み合わせたAgent Teams構成による自動化システムの構築まで手がけています。</p>
          <p className="text-slate-500">関西在住。リモート・通勤いずれも対応可能です。</p>
        </div>
      </section>
